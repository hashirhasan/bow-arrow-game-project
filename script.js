var myGamePiece;
		...
		function startGame() {
			...
			myScore = new component("30px", "serif", "black", 820, 40, "text");
			chances = new component("30px", "serif", "white", 650, 40, "text");
			finalScore = new component("40px", "serif", "white", 380, 360, "text");
		...
		var  time=0,time1=0,run=1,delay=0,arrowspeed=7,run=1,balloonspeed=-2,points=1,balloon_miss=0,lives=8,pos=620;
